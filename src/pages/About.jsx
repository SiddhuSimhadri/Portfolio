    ...
    return (
        <section className='max-container'>
            <h1 className='head-text'>
                Hello, I am <span className='blue-gradient_text font-semibold drop-shadow'>Siddhu</span> 👋
            </h1>
            <div className='mt-5 flex flex-col gap-3 text-slate-500'>
                <p>Software Engineering Student at KLU, specializing in technical education through hands-on learning and buiding applications</p>
            </div>
